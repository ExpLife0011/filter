#ifndef __FBACKUP_NTAPIEX_H__
#define __FBACKUP_NTAPIEX_H__
...
NTSYSAPI
    NTSTATUS
    RtlIntegerToChar(ULONG Value, ULONG Base, ULONG Length, PCHAR Str);

FORCEINLINE BOOLEAN MmIsSessionAddress(PVOID Addr) {
    ULONG_PTR uAddr = (ULONG_PTR)Addr;
#if defined(_AMD64_)
    return (uAddr >= 0xFFFFF90000000000ULL) ? TRUE : FALSE;
#else
